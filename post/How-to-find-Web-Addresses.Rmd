---
title: How-to-find-web-Addresses
author: ''
date: '2020-12-08'
slug: how-to-find-web-addresses
categories: []
tags: []
description: ''
---
...
ip = re.findall( r'[0-9]+(?:\.[0-9]+){3}', string2 )
ip
```
...
Jan 13 17:52:08: ACCEPT service http from 213.121.184.130 to firewall(pub-nic), prefix: \"none\" \
(in: eth0 213.121.184.130(00:05:2e:6a:a4:14):8504 -> 140.105.63.164(00:60:11:92:ed:1b):80 TCP flags: ****S* len:52 ttl:109)"
mac = re.findall( r'(?:[0-9a-fA-F]:?){12}', string2 )
mac
```
![](/post/How-to-find-Web-Addresses_files/Beijing_bouddhist_monk_2009_IMG_1486.jpeg)